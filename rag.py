...
def initialize_components():
    ...
    if llm is None:
        llm = ChatGroq(model="llama-3.3-70b-versatile", temperature=0.9, max_tokens=4000)
...
def process_urls(urls):
    ...
    text_splitter = RecursiveCharacterTextSplitter(
        ...
        chunk_overlap=500   # 👈 NEW: 200 characters overlap
...
def generate_answer(query):
    ...
    chain = RetrievalQAWithSourcesChain(combine_documents_chain=qa_chain, retriever=vector_store.as_retriever(search_kwargs={"k": 5}),
